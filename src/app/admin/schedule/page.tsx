...
export default function ScheduleManagementPage() {
  ...
  const fetchSchedules = async () => {
    ...
    const dummySchedules: Schedule[] = [
      {
        id: 'schedule-1',
        title: 'React 기초 강의',
        description: 'React의 기본 개념과 사용법을 배우는 강의입니다.',
        type: 'lecture',
        status: 'scheduled',
      ...
      },
      {
        id: 'schedule-3',
        title: 'Next.js 심화 강의',
        description: 'Next.js의 고급 기능과 최적화 기법을 다룹니다.',
        type: 'lecture',
        status: 'in_progress',
      ...
      },
      {
        id: 'schedule-4',
        title: '웹 개발 컨퍼런스',
        description: '최신 웹 개발 트렌드와 기술 공유',
        type: 'event',
        status: 'scheduled',
      ...
      },
      {
        id: 'schedule-5',
        title: '데이터베이스 설계 워크샵',
        description: '효율적인 데이터베이스 설계 방법론 학습',
        type: 'lecture',
        status: 'cancelled',
    ...
    let filteredSchedules = dummySchedules.filter(schedule => {
