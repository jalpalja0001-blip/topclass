...
export default function EbookManagementPage() {
  ...
  const fetchEbooks = async () => {
    try {
      ...
      const dummyEbooks: Ebook[] = [
        {
          id: 'ebook-1',
          title: 'React 완벽 가이드',
          description: 'React의 모든 것을 다루는 종합 가이드북입니다.',
          author: '김개발자',
          category: '프로그래밍',
        ...
        },
        {
          ...
          description: 'Next.js를 활용한 실전 프로젝트 개발 가이드입니다.',
          author: '이프론트',
          category: '프로그래밍',
        ...
        },
        {
          id: 'ebook-3',
          title: 'UI/UX 디자인 기초',
          description: 'UI/UX 디자인의 기본 원리와 실무 노하우를 담은 가이드입니다.',
          author: '박디자이너',
          category: '디자인',
        ...
        },
        {
          id: 'ebook-4',
          title: '데이터베이스 설계 가이드',
          description: '효율적인 데이터베이스 설계를 위한 실무 가이드입니다.',
          author: '최백엔드',
          category: '프로그래밍',
        ...
        },
        {
          id: 'ebook-5',
          title: '마케팅 전략 수립',
          description: '효과적인 마케팅 전략을 수립하는 방법을 다룹니다.',
          author: '정마케터',
          category: '마케팅',
      ...
      // 필터링 적용
      let filteredEbooks = dummyEbooks
